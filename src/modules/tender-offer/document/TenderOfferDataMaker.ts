...
import { TENDER_OFFER } from "@/modules/tender-offer/config/texts";
...
} from "@/modules/tender-offer/config/CRITERION_VALUES";
import { CriteriaTransformer } from "@/modules/tender-offer/services/CriteriaTransformer";
import { StringHandler } from "@/utils/StringHandler";
import { EvidenceFormatter } from "@/modules/tender-offer/services/EvidenceFormatter";
import { Assert } from "@/widgets/ErrorExceptionCore/Assert";
import { ERROR_MESSAGES } from "@/widgets/ErrorExceptionCore/configs/messages";
import { MainInformationBuilder } from "@/modules/tender-offer/services/MainInformation.builder";
...
} from "@/modules/tender-offer/config/criterionTables.config";
...
export class TenderOfferDataMaker extends AbstractDocumentStrategy {
  ...
  private getAllTableRowsFromItems(
    ...
    return items.map(item => {
      ...
      return { key: new Date().getTime().toString(), mainRow, additional };
    });
  }
