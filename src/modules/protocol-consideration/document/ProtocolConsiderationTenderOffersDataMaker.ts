...
import { PROTOCOL_CONSIDERATION_TENDER_OFFERS } from "@/modules/protocol-consideration/config/texts";
import * as PDF_HELPER_CONST from "@/constants/pdf/pdfHelperConstants";
import type { SignerType } from "@/types/sign/SignerType";
import { MARGIN_TOP_10__BOTTOM_15, MARGIN_TOP_3 } from "@/modules/protocol-consideration/config/constants";
