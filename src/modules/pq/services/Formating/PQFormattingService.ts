...
import { PdfItemEnum } from "@/types/pq/TextConfigType";
import { STRING } from "@/constants/string";
import { PQ_LIST_HEADING_MARGIN, PQ_PARAGRAPH_MARGIN } from "@/config/pdf/pqMargins";
...
import { CompoundTextAdapter } from "@/modules/pq/services/Formating/CompoundTextAdapter";
...
export class PQFormattingService {
  ...
  static formatCompoundTextItem(
    ...
    if ((olItem as CompoundTextType).pdfType === PdfItemEnum.FORMATTED_LIST_ITEM) {
      acc.listText.push(
        this.formatOlItem((olItem as CompoundTextType).text, listIndex, itemIndex, consecutiveNoMarkerText)
      );
