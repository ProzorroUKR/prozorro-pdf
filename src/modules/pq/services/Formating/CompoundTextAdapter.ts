...
import { pqGenericBase } from "@/modules/pq/templates/generic/configs/pqGenericTexts";
import { PQpaymentDetails } from "@/modules/pq/services/PQpaymentDetails/PQpaymentDetails";
import { EnsuringRequirementsParser } from "@/modules/pq/services/ContractEnsuring/EnsuringRequirementsParser";
import {
  ENSURING_PERCENT_REQUIREMENTS,
  ENSURING_PERIOD_REQUIREMENTS,
} from "@/modules/pq/services/ContractEnsuring/config/PQreqirements";
import { EnsuringOptionToTextMap } from "@/modules/pq/services/ContractEnsuring/config/EnsuringOptionToTextMap";
import { pqBase } from "@/modules/pq/configs/pqTexts";
