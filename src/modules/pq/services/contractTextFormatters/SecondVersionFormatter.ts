import type { PQContractType, PQItem, PQsupplier } from "@/types/pq/PQTypes";
import { DocumentExtractionService } from "@/services/PDF/document/DocumentExtractionService";
import { PQFormattingService } from "@/modules/pq/services/Formating/PQFormattingService";
import {
  pqGenericAddition1Texts,
  pqGenericAddition2Texts,
  pqGenericBase,
} from "@/modules/pq/templates/generic/configs/pqGenericTexts";
import { DEFAULT_TEXT_FIELDS, STRING } from "@/constants/string";
import { pqBase, pqSignature } from "@/modules/pq/configs/pqTexts";
import {
  HEADING_MARGIN,
...
import { AllVersionFormatter } from "@/modules/pq/services/contractTextFormatters/AllVersionFormatter";
import { ContractPendingChecker } from "@/modules/pq/utils/ContractPendingChecker";
import type { PDFTableBodyType } from "@/types/pq/TextConfigType";
import { ProductAttributesHandler } from "@/modules/pq/services/Products/ProductAttributesHandler";
import { PDFTablesHandler } from "@/services/PDF/Formatting/PDFTablesHandler";
import * as TABLES_HELPER from "@/modules/pq/configs/tablesConfig";
import * as PDF_HELPER_CONST from "@/constants/pdf/pdfHelperConstants";
import { PriceHandler } from "@/services/Common/PriceHandler";
import { TemplateToTableHead } from "@/modules/pq/configs/TableHead.map";
import {
  genericTableAddressHeader,
  genericTableItemsHeader,
} from "@/modules/pq/templates/generic/configs/genericContract.config";
...
import { ContractEnsuring } from "@/modules/pq/services/ContractEnsuring/ContractEnsuring";
