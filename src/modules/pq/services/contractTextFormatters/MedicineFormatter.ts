...
import { PQ_SPECIFICATION_HEADING_MARGIN, PQ_TESTING_GROUNDS_MARGIN } from "@/config/pdf/pqMargins";
import { labAnalysisTexts, testingGroundsTexts } from "@/modules/pq/templates/medicine/configs/medicineContract.config";
