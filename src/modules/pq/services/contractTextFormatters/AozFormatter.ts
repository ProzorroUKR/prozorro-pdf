import type { PQContractType, PQItem, PQsupplier } from "@/types/pq/PQTypes.ts";
import { deepClone } from "@/utils/helpers.ts";
import { PDF_FILED_KEYS } from "@/constants/pdf/pdfFieldKeys.ts";
import { pqBase } from "@/modules/pq/configs/pqTexts.ts";
...
import { pqAozTexts } from "@/modules/pq/templates/aoz/configs/pqAozTexts.ts";
import { PQFormattingService } from "@/modules/pq/services/Formating/PQFormattingService.ts";
import { pqGenericBase } from "@/modules/pq/templates/generic/configs/pqGenericTexts.ts";
import { pqNushTexts } from "@/modules/pq/templates/nush/configs/pqNushTexts.ts";
import { ContractPendingChecker } from "@/modules/pq/utils/ContractPendingChecker.ts";
import type { PDFTableBodyType } from "@/types/pq/TextConfigType.ts";
import { PDFTablesHandler } from "@/services/PDF/Formatting/PDFTablesHandler.ts";
import * as TABLES_HELPER from "@/modules/pq/configs/tablesConfig.ts";
import { SecondVersionFormatter } from "@/modules/pq/services/contractTextFormatters/SecondVersionFormatter.ts";
...
} from "@/modules/pq/templates/aoz/configs/aozContract.config.ts";
import { CompoundTextAdapter } from "@/modules/pq/services/Formating/CompoundTextAdapter.ts";
import { FormattingFunctionsEnum } from "@/modules/pq/services/Formating/config/FormattingFunctions.enum.ts";
