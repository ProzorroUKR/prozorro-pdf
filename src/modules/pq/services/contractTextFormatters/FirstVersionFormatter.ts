...
import { pqBase, pqSignature, pqSpecificationTexts } from "@/modules/pq/configs/pqTexts";
...
import { ItemAttributesFormatter } from "@/modules/pq/services/Items/ItemAttributesFormatter";
import { PriceHandler } from "@/services/Common/PriceHandler";
import { PDF_STYLES } from "@/config/pdf/pdfStyles";
import { PQ_LIST_HEADING_MARGIN, PQ_SPECIFICATION_HEADING_MARGIN } from "@/config/pdf/pqMargins";
...
import { TemplateToSpecificationListMap } from "@/modules/pq/configs/TemplateToSpecificationList.map";
...
import { ClassificationTransformer } from "@/services/Common/ClassificationTransformer";
