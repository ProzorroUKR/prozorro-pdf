...
export const beforeXDate = new Map<string, string | Record<string, any>>()
  ...
  .set(
    "infoAboutSubject",
    CONCLUSION_OF_MONITORING_TEXTS_LIST.info_about_subject_old
  )
  .set(
    "conclusionOnPresence",
    CONCLUSION_OF_MONITORING_TEXTS_LIST.conclusion_on_presence
  )
...
export const afterXDate = new Map<string, string | Record<string, any>>()
  ...
  .set(
    "infoAboutSubject",
    CONCLUSION_OF_MONITORING_TEXTS_LIST.info_about_subject_new
  )
  .set(
    "conclusionOnPresence",
    CONCLUSION_OF_MONITORING_TEXTS_LIST.conclusion_on_presence
...
export const afterYDate = new Map<string, string | Record<string, any>>()
  ...
  .set(
    "conclusionOnPresence",
    CONCLUSION_OF_MONITORING_TEXTS_LIST.conclusion_on_presence_y
  )
