export const ANNOUNCEMENT_TEXTS_LIST: Record<string, string> = {
  ...
  customer_contact_person:
    "Контактна особа замовника, уповноважена здійснювати звʼязок з учасниками:",
  ...
  securement_terms:
    "Умови надання забезпечення тендерних пропозицій/пропозицій",
  ...
  frame_contact_amount:
    "Кількість учасників, з якими буде укладено рамкову угоду:",
  plans:
    "План, відповідно до якого проводиться закупівля (інформація про джерело фінансування)",
