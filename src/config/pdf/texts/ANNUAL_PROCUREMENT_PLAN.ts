export const ANNOUNCEMENT_TEXTS_LIST: Record<string, string> = {
  ...
  customer_organization_edr_id:
    "Ідентифікаційний код організатора закупівлі в ЄДР:",
  ...
  procuring_entity_code:
    "Код згідно з Єдиним закупівельним словником предмета закупівлі:",
  additional_procuring_entity_code:
  ...
  classifiers_names_table:
    "Назви відповідних класифікаторів предмета закупівлі (за наявності)",
  reasons_for_purchase_by_customer:
    "Обґрунтування підстав для здійснення замовником закупівлі:",
  has_been_resolved: "Вирішено:",
  has_been_resolved_text:
    "Затвердити річний план закупівлі та опублікувати на веб-порталі Уповноваженого органу",
